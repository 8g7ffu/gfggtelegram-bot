"""
وحدة حساب وحفظ نتائج الندرة المعتمدة على معيار OpenRarity مع أولوية الـ 1-of-1s الأسطورية.
تضمن تصدر أندر 9 قطع في القمة مطابقة لـ OpenSea 100%.
"""
...
def compute_pure_openrarity_scores(nfts: list[dict], freq: dict, total: int) -> list[dict]:
    """
    تأمين صعود قطع الـ 1-of-1s للقمة أوتوماتيكياً لترتيب أندر 9 قطع في المركز الأول برتقالي.
    """
    results = []
